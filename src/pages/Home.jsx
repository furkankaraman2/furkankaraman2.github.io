...
export default function Home({ lang }) {
  ...
  return <>
    ...
    <section className="home-patent-feature section-pad">
      ...
      <div className="home-patent-media premium-illustration" data-reveal data-parallax><img loading="lazy" decoding="async" width="1200" height="860" src="/images/illustrations/patent-global-partnership.svg" alt={lang==='en'?'Editorial illustration of global IP strategy and pharmaceutical partnership':'Global IP stratejisi ve ilaç sektörü ortaklığını anlatan editoryal illüstrasyon'}/><div className="patent-media-overlay"><LineArt variant="patent"/><span>IP · TTO · SPIN-OFF · FUNDING · PHARMA PARTNERSHIP</span></div></div>
    </section>
